...
$Materias = "Materias";
$Ano = $_POST['Ano'];
$rutacasicompleta = "../../view/Cursos/$Ano/$Materias";
$Nombre = $_POST['Nombre'];
$rutacompleta = "../../view/Cursos/$Ano/Materias/$Nombre";
...
header("location:../../view/administrador/Materias.php?Curso=".$Ano."");
//Crear Nueva Carpeta Curso
}else if(isset($_POST['Nombre'])){
$Nombre = $_POST['Nombre'];
$rutacompleta = "../../view/Cursos/$Nombre";
if(isset($rutacompleta)){
    if(!file_exists($rutacompleta)){
        mkdir($rutacompleta);
        $mensaje = "Se ha creado la carpeta: $rutacompleta;";
