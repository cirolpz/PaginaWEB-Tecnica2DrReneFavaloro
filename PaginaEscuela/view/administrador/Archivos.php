...
<body style="background-color:#e9ecef;"><!-- Menu -->
						...
						<table border="1" id="dtBasicExample" class="table text-center table-striped">
							...
							<tbody>
								...
								while( $archivo = readdir($dir)){
									...
									echo "<td>". '<a href="../../controller/Administrador/EliminarArchivo.php?Archivo=../../view/Cursos/'.$Curso.'/'.'Materias/'.$Materia.'/'.$archivo.'&'.'Ano='.$Curso.'&'.'Materia='.$Materia.'"><button type="button" class="btn btn-danger btn-sm" onclick="return ConfirmDelete()"> Eliminar </button>'."</a> </td>";
